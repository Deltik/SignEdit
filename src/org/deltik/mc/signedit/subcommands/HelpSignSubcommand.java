...
import static org.deltik.mc.signedit.commands.SignCommand.COMMAND_NAME;
...
public class HelpSignSubcommand implements SignSubcommand {
    ...
    public SignEditInteraction execute() {
        ...
        if (allowedCommands.size() == 0) {
            comms.informForbidden(COMMAND_NAME, args.getSubcommand());
            return null;
        }
    ...
    public void showSubcommandSyntax(String[] commandSegments) {
        ...
        if (commandSegmentsList.size() == 0) {
            showSubcommandSyntax(COMMAND_NAME);
            return;
        }
    ...
    protected List<String[]> getAllowedCommands() {
        ...
        String signCommandUsage = (String) about.getCommands().get(COMMAND_NAME).get("usage");
