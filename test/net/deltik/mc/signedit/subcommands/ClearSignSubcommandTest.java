...
public class ClearSignSubcommandTest {
    ...
    private ClearSignSubcommand createSubcommand(String args) {
        ...
        return new ClearSignSubcommand(context);
    }

    @Test
    public void tabCompletionReturnsEmptyEvenWhenLookingAtSign() {
        Sign sign = createSign(fancySignLines);
        setupPlayerLookingAtSign(sign);

        ClearSignSubcommand subcommand = createSubcommand("clear 1-4 ");
        List<String> completions = subcommand.getTabCompletions(argParse("clear 1-4 "));

        assertEquals(0, completions.size());
    }

    @Test
    public void tabCompletionReturnsEmptyWithLineSelector() {
        Sign sign = createSign(fancySignLines);
        setupPlayerLookingAtSign(sign);

        ClearSignSubcommand subcommand = createSubcommand("clear 1 ");
        List<String> completions = subcommand.getTabCompletions(argParse("clear 1 "));

        assertEquals(0, completions.size());
    }

    @Test
    public void tabCompletionReturnsEmptyWithNoArgs() {
        Sign sign = createSign(fancySignLines);
        setupPlayerLookingAtSign(sign);

        ClearSignSubcommand subcommand = createSubcommand("clear ");
        List<String> completions = subcommand.getTabCompletions(argParse("clear "));
